...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5793&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-tidyposterior-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-tidyposterior` can be installed with `conda`:
...
```
mamba install r-tidyposterior
```

It is possible to list all of the versions of `r-tidyposterior` available on your platform with `conda`:
...
```
mamba search r-tidyposterior --channel conda-forge
```
...
mamba repoquery search r-tidyposterior --channel conda-forge

# List packages depending on `r-tidyposterior`:
mamba repoquery whoneeds r-tidyposterior --channel conda-forge

# List dependencies of `r-tidyposterior`:
mamba repoquery depends r-tidyposterior --channel conda-forge
```
